...
LLM_CONFIG = {
    ...
    "model_name": os.environ.get("ALIGO_MODEL_NAME", "glm-5.2-fast-preview"),
    "base_url": os.environ.get("ALIGO_BASE_URL", "https://ws-qvg9u4gn3ewyjs3t.cn-beijing.maas.aliyuncs.com/compatible-mode/v1"),
    "temperature": 0.7,
