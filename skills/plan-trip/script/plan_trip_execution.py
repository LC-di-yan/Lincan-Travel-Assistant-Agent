...
def load_agent_module(skill_name, agent_class_name):
    ...
    # Current: skills/plan-trip/script/plan_trip_execution.py
    # Target: skills/<skill_name>/script/agent.py
    current_file = Path(__file__).resolve()
    skills_dir = current_file.parent.parent.parent  # Go up to skills/
